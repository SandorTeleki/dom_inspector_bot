...
function getHelpEmbed() {
	return new EmbedBuilder()
		...
		.setDescription('The Dom_Inspector_Bot provides you info on items, spells, units, sites, mercenaries, and events for Dominions 6.')
		.addFields(
			...
			{ name: '```/event {event_name}```', value: 'Search for events by its text (or id).' },
