...
describe('Test button wrapper functionality', () => {
    test('returns a partial row of arrays if it receives 4 buttons', () => {
    ...
    test('returns one full and a partial row of arrays if it receives 9 buttons', () => {
    ...
    test('returns five full rows of arrays if it receives 25 buttons', () => {
    ...
    test('returns five full rows of arrays even if it receives more than the maximum amount of buttons', () => {
